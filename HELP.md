...
* The original package name 'com.renatinha.fleet-management' is invalid and this project uses 'com.renatinha.fleetmanagement' instead.
...
* [Docker Compose Support](https://docs.spring.io/spring-boot/docs/3.1.11/reference/htmlsingle/index.html#features.docker-compose)
